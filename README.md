...
- On Linux, the plan: the entries, a refused key, an omitted default on iOS
  and on macOS and the three refusals of `omit_keys`, the embedded profile, the
